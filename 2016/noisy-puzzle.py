...
#* PARA LAS SOLUCIONES, ESCRIBIR EN LA LINEA DE COMANDOS:
#* Parte 1: --> python.exe noisy-puzzle.py --favorite 1364 --target 31,39
#* Parte 2: --> python.exe noisy-puzzle.py --favorite 1364 --fill 50
